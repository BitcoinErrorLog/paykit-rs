...
//!
//! This module provides a simplified interface for interacting with the Pubky directory
//! to publish and query payment methods.
//!
//! For session creation, use `crate::SessionManager` instead.
