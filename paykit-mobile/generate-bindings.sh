...
echo "  - ExecutorAsyncBridge: Async executor operations with timeout"
echo ""
echo "Executor Callback Interfaces (Bitkit Integration):"
echo "  - BitcoinExecutorFFI: Implement for on-chain payments"
echo "  - LightningExecutorFFI: Implement for Lightning payments"
echo "  - BitcoinTxResultFFI, LightningPaymentResultFFI: Result types"
echo "  - BitcoinNetworkFFI, LightningNetworkFFI: Network configuration"
echo ""
echo "PaykitClient Executor Methods:"
echo "  - new_with_network: Create client with network config"
echo "  - register_bitcoin_executor: Register Bitcoin wallet"
echo "  - register_lightning_executor: Register Lightning node"
echo "  - execute_payment: Execute payment via registered executor"
echo "  - generate_payment_proof: Get txid/preimage proof"
echo ""
...
echo "  - paykit-mobile/BITKIT_INTEGRATION_GUIDE.md"
echo "  - paykit-mobile/FFI_API_REFERENCE.md"
echo ""
echo "Done!"
