...
///
/// Note: Size difference between variants is acceptable here as responses
/// are processed individually and rarely stored in arrays. The Accepted
/// variant contains a PaykitReceipt which is necessarily large.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(tag = "type")]
